...
public class ConstantesMenuEstoque {
	...
	public static final int REMOVER = 5;
	public static final int ATIVAR_NOTA_FICAL = 6;
	public static final int LISTAGEM_VENDAS = 7;
	public static final int DETALHES_VENDA = 8;
	public static final int VOLTAR = 9;
